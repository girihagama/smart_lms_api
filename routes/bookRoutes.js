...
router.post('/add', authorizeRole(['Member','Librarian']), upload.single('book_image'), async (req, res) => {
    try {
        const {
            book_name,
            book_description,
        ...
        await req.app.locals.db.query(
            ...
            [book_id, book_name, book_description, defaultLateFee, defaultCondition, defaultStatus, book_image]
        );
